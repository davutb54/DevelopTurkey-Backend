...
public static class CapabilitySeeder
{
    public static void Seed(DevelopTurkeyContext context)
    {
        var definitions = new (string Code, string Description, string Category)[]
        {
            ...
            ("admin.announcement_read",   "Duyuruları admin panelinden görme.",                                        "admin"),
            ("admin.announcement_create", "Yeni duyuru oluşturma ve mevcut duyuruyu devre dışı bırakma.",              "admin"),
            ("admin.announcement_delete", "Duyuru silme.",                                                             "admin"),
            ...
            ("workflow.action.grant_capability",           "Workflow 'grant_capability' actionını kullanma.",           "workflow.action"),
            ("workflow.action.apply_capability_template",  "Workflow 'apply_capability_template' actionını kullanma.",  "workflow.action"),
            ...
            ("workflow.action.assign_problem_institution", "Workflow 'assign_problem_institution' actionını kullanma.", "workflow.action"),
            ("workflow.action.change_problem_status",      "Workflow 'change_problem_status' actionını kullanma.",      "workflow.action"),
            ...
            ("workflow.action.create_announcement",        "Workflow 'create_announcement' actionını kullanma.",        "workflow.action"),
            ("workflow.action.trigger_workflow",           "Workflow 'trigger_workflow' actionını kullanma.",           "workflow.action"),
        };
